...
int main() {
	...
	Shader ourShader("C:/Users/shama/Documents/Learning/OpenGL/src/1.getting_started/5.transform/5.3.transformations_exercise1.vs", 
		"C:/Users/shama/Documents/Learning/OpenGL/src/1.getting_started/5.transform/5.3.transformations_exercise1.fs");
...
// -------------------------
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		trans = glm::scale(trans, glm::vec3(0.5, 1, 0.5));
