...
void bindAndRegisterVertices(const int& VAO, const int& VBO, unsigned int vertices[]);
...
void bindAndRegisterVertices(unsigned int& VAO, unsigned int& VBO, unsigned int vertices[]) {
