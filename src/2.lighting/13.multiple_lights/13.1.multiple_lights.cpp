...
int main() {
	...
	Shader ourShader("C:/Users/shama/Documents/Learning/OpenGL/src/2.lighting/13.multiple_lights/13.1.multiple_lights.vs",
		"C:/Users/shama/Documents/Learning/OpenGL/src/2.lighting/13.multiple_lights/13.1.multiple_lights.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		*/
		...
		for (int i = 0; i < 4; i++) {
			...
			lightingShader.setVec3("lightColor", 1.0f, 0.5f, 0.0f);
