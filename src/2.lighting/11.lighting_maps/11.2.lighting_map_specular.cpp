...
// lighting
glm::vec3 lightPos(0.5f, 0.0f, 4.0f);
...
int main() {
	...
	Shader ourShader("C:/Users/shama/Documents/Learning/OpenGL/src/2.lighting/12.light_casters/12.1.directional_light.vs",
		"C:/Users/shama/Documents/Learning/OpenGL/src/2.lighting/12.light_casters/12.1.directional_light.fs");
	...
	unsigned int specularMap = loadTexture("C:/Users/shama/Documents/Learning/OpenGL/JoeyDeVries/resources/textures/matrix.jpg");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		*/
		...
		ourShader.setVec3("light.ambient", 0.2f, 0.2f, 0.2f); // note that all light colors are set at full intensity
