...
int main() {
	...
	Shader ourShader("C:/Users/shama/Documents/Learning/OpenGL/src/2.lighting/9.basic_lighting/8.6.exercise3.vs",
		"C:/Users/shama/Documents/Learning/OpenGL/src/2.lighting/9.basic_lighting/8.6.exercise3.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// lightPos.x = (float)(sin(glfwGetTime()) * 1);
		// lightPos.y = (float)(cos(glfwGetTime()) * 1);
